...
// Setup conf TEST_MYPARAM1 as a simple string input
$item = $formSetup->newItem('TEST_MYPARAM1');
$item->defaultFieldValue = 'default value';

// Setup conf TEST_MYPARAM2 as a simple textarea input but we replace the text of field title
$item = $formSetup->newItem('TEST_MYPARAM2');
$item->nameText = $item->getNameText().' more html text ';

// Setup conf TEST_MYPARAM3
$item = $formSetup->newItem('TEST_MYPARAM3');
$item->setAsThirdpartyType();

// Setup conf TEST_MYPARAM4 : exemple of quick define write style
$formSetup->newItem('TEST_MYPARAM4')->setAsYesNo();

// Setup conf TEST_MYPARAM5
$formSetup->newItem('TEST_MYPARAM5')->setAsEmailTemplate('thirdparty');

// Setup conf TEST_MYPARAM6
$formSetup->newItem('TEST_MYPARAM6')->setAsSecureKey()->enabled = 0; // disabled

// Setup conf TEST_MYPARAM7
$formSetup->newItem('TEST_MYPARAM7')->setAsProduct();

$formSetup->newItem('Title')->setAsTitle();

// Setup conf TEST_MYPARAM8
$item = $formSetup->newItem('TEST_MYPARAM8');
$TField = array(
...
$item->helpText = $langs->transnoentities('TEST_MYPARAM8');


// Setup conf TEST_MYPARAM9
