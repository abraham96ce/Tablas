...
/**
 * \file    test/phpunit/TestFunctionalTest.php
 * \ingroup test
...
class TestFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/test/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('test/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/test/admin/about.php');
		$this->authenticate();
		return $this->assertContains('test/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('testwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTest_TestTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTest_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
